 ...
 */
package net.pellse.decorator.proxy.bytebuddy;

import static net.bytebuddy.matcher.ElementMatchers.isAbstract;
import static net.bytebuddy.matcher.ElementMatchers.isDeclaredBy;
import static net.bytebuddy.matcher.ElementMatchers.isGetter;
import static net.bytebuddy.matcher.ElementMatchers.not;
import static net.pellse.decorator.util.reflection.Injector.injectField;
import static net.pellse.decorator.util.reflection.ReflectionUtils.newInstance;
import static net.pellse.decorator.util.reflection.ReflectionUtils.setField;
...
import net.pellse.decorator.DelegateProvider;
import net.pellse.decorator.aop.DelegateInvocationHandler;
import net.pellse.decorator.proxy.DelegateGenerator;
